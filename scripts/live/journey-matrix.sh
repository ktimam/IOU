...
# which opens a disposable proposer tab with the URL-only `?manualExtract=1` seam. The normal
# signed-in tab, persistent profile state, and installed model are never mutated.
#
